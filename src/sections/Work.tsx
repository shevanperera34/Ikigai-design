...
const projects: Project[] = [
  ...
  objective:
    'Create an immersive product experience that increases engagement and shortens the sales cycle for a visually complex product.',
  roles: ['UI/UX Design', '3D Integration', 'Front-end Dev', 'Copywriting', 'Brand Direction'],
  tools: ['React', 'TypeScript', 'Three.js', 'Vite'],
  outcomes: [
    'Increased demo engagement through real-time interaction',
    'Modular 3D system built for future product expansion',
  ],
...
},
{
  ...
  objective:
    'Reduce drop-off during booking by simplifying navigation and guiding users toward clear next steps.',
  roles: ['UI/UX Design', 'Front-end Dev', 'Content Structuring'],
  tools: ['React', 'TypeScript', 'Headless CMS', 'Cloud Functions'],
  outcomes: [
    'Improved appointment request flow',
    'Reusable booking component designed for scale',
  ],
  ctaLabel: 'View Case Study',
},
{
  ...
  objective:
    'Create a flexible front-end foundation that supports fast launches without sacrificing quality or accessibility.',
  roles: ['Design System', 'Front-end Dev', 'QA'],
  tools: ['React', 'TypeScript', 'Tailwind', 'Storybook'],
  outcomes: [
    'Stable layouts with reduced CLS issues',
    'Single, maintainable codebase across breakpoints',
  ],
  ctaLabel: 'View Case Study',
},
{
  ...
  objective:
    'Drive bookings and reinforce brand identity through strong visual hierarchy and intuitive flow.',
  roles: ['UI/UX Design', 'Front-end Dev', 'Copywriting'],
  tools: ['React', 'TypeScript', 'Tailwind', 'Cloud Images'],
  outcomes: [
    'High Lighthouse performance during prototype testing',
    'Streamlined booking completion experience',
  ],
  ctaLabel: 'View Case Study',
},
{
  ...
  objective:
    'Convert paid traffic efficiently by reducing decision fatigue and emphasizing clear value tiers.',
  roles: ['Landing Page', 'Front-end Dev', 'CRO'],
  tools: ['React', 'TypeScript', 'Tailwind', 'Framer Motion'],
  outcomes: [
    'Reusable pricing grid for future campaigns',
    'Analytics events implemented for conversion tracking',
  ],
  ctaLabel: 'View Case Study',
},
{
  ...
  objective:
    'Deliver a short-form video asset that captures atmosphere and extends event reach beyond the venue.',
  roles: ['Cinematography', 'Editing', 'Sound Design'],
  tools: ['Sony Mirrorless', 'Final Cut Pro', 'Adobe Audition'],
  outcomes: [
    'Cut-downs optimized for reels and stories',
    'Export presets created for repeat use',
  ],
  ctaLabel: 'View Case Study',
},
{
  ...
  outcomes: [
    'Modular motion template for future promos',
    'Consistent on-brand visual language established',
  ],
  ctaLabel: 'View Case Study',
},
{
  ...
  objective:
    'Build a cohesive visual language that supports storytelling, product launches, and long-term growth.',
  roles: ['Brand Direction', 'Art Direction', 'Copywriting', 'Product Mockups'],
  tools: ['Photoshop', 'Illustrator', 'Blender'],
  outcomes: [
    'Consistent brand kit across platforms',
    'Product designs prepared for launch and iteration',
  ],
  ctaLabel: 'View Case Study',
},
]
