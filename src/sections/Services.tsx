...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-6 md:px-10 py-8 sm:py-10 md:py-14">
...
<text
  ...
  fontSize="18"
  fill="white"
  opacity={!showCustom && activeKey === "brand" ? 0.95 : 0.75}
...
<text
  ...
  fontSize="18"
  fill="white"
  opacity={!showCustom && activeKey === "web" ? 0.95 : 0.75}
  className="font-[Space_Grotesk] uppercase tracking-[0.25em] select-none pointer-events-none"
>
  WEB INFRASTRUCTURE
</text>
...
<text
  ...
  fontSize="18"
  fill="white"
  opacity={!showCustom && activeKey === "growth" ? 0.95 : 0.75}
  className="font-[Space_Grotesk] uppercase tracking-[0.25em] select-none pointer-events-none"
>
  GROWTH ARCHITECTURE
</text>
