...
type TeamMember = {
  ...
  // long about content (optional for others for now)
  about?: string;
  whatIDo?: string[];
  toolbox?: Toolbox;
...
const TEAM: TeamMember[] = [
  {
    ...
    // ✅ NEW: full about content for About page
    about:
...
function TeamTile({ member }: { member: TeamMember }) {
  ...
  return (
    <button
      onClick={() => navigate("/about", { state: { memberKey: member.key } })}
