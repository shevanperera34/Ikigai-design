  ...
  Seni: [
    {
      ...
      items: ['Azure, AWS', 'Windows Server, AD / GPO', 'Linux (Fedora, Arch, Debian)', 'Aruba/Cisco networking', 'SCCM / imaging / endpoint'],
    },
  ...
  Shevan: [
    {
      ...
      items: ['Photoshop, Illustrator, InDesign', 'Premiere Pro, Final Cut Pro', 'After Effects (motion templates)'],
    },
...
const LinkedInIcon = ({ size = 16 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 382 382" fill="currentColor" aria-hidden="true">
    <path
      ...
      <div className="relative p-3">
        <div className="rounded-xl overflow-hidden ring-1 ring-white/20 bg-white/[0.06]">
          <div className="aspect-[3/4] w-full">
            <img src={member.imageUrl} alt={member.name} className={`h-full w-full object-cover ${member.imgClass ?? ''}`} />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[420px_minmax(0,1fr)] gap-0">
            ...
            <div className="relative lg:sticky lg:top-0 p-5 md:p-8 self-start">
              <div className="relative w-full h-[480px] lg:h-[calc(100vh-10rem)] rounded-2xl overflow-hidden ring-1 ring-white/20 bg-black/30">
                <img src={member.imageUrl} alt={member.name} className={`absolute inset-0 w-full h-full object-cover ${member.imgClass ?? ''}`} />
  ...
  return (
    <section className="relative min-h-[110vh] overflow-hidden text-white font-[Inter] bg-[#060a18]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-10 py-24 md:py-32">
        <h1 className="text-center font-[Space_Grotesk] uppercase tracking-widest text-3xl md:text-5xl">Who We Are</h1>
        ...
        <div className="text-center mt-4 space-y-7 text-base md:text-lg leading-relaxed text-white/90 max-w-4xl mx-auto">
          <p>
            The Ikigai Project exists to help companies and individuals operate at their full potential. We design web and digital systems that create confidence first, financial
            momentum second, and long-term alignment always.
          </p>
          <p>
            Our work sits at the intersection of design, advertising, and technology. Not for complexity’s sake, but to build systems that last, scale, and actually move the needle.
          </p>
        </div>
